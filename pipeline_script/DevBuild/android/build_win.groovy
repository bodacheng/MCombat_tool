        ...
        stage('yaml取得/初期化') {
            steps {
                script {
                    ...
                    def script = "powershell -Command \"Get-Content '${yamlFile}' | Select-String -Pattern '^productName:' | ForEach-Object { \$_.ToString().Trim() -replace '^productName:\\s*', '' } | Out-String | Select-Object -Last 1\""
